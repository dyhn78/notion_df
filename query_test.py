...
from db_handler.parser import DatabaseParser as DBParser, PagesParser as DBQueryReader
...
test_db_query_maker.add_db_retrieve(DBParser(test_database))
...
plain_items = DBQueryReader(test_subpages).listed_items
pprint(plain_items)
