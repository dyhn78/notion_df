...
class DatabaseEnum(Enum):
    ...
    stage_db = ('줄기', 'addc94642ee74825bd31109f4fd1c9ee', EmojiCode.RED_HEART)
    thread_db = ('수행', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.YELLOW_CIRCLE)
    ...
    view_db = ('조망', '52d387ea0aaa470cb69332708c61b34d', EmojiCode.GREEN_HEART)
...
upper = "상위"
lower = "하위"
record_to_sch_datei_prop = RelationProperty(DatabaseEnum.datei_db.prefix + progress) # TODO
...
record_to_view_prop = RelationProperty(DatabaseEnum.view_db.prefix_title)
