...
from notion_df.object.common import StatusGroups, SelectOptions, SelectOption
from notion_df.object.constant import NumberFormat, RollupFunction, Number
from notion_df.object.file import Files
from notion_df.object.filter import (
    PropertyFilter, FilterBuilder_T, CheckboxFilterBuilder, PeopleFilterBuilder, DateFilterBuilder, TextFilterBuilder,
...
class PropertyKey(Generic[FilterBuilder_T], metaclass=ABCMeta):
    ...
    def _deserialize_page_value(self, prop_serialized: dict[str, Any], typename: str) -> PropertyValue_T:
        return deserialize(self.page, prop_serialized[typename])
