...
from typing import Final, Mapping, Literal, Iterator, TypeVar, Any
...
class FieldLateSync(LateSync, FieldEventListener[Entity_T, Value_T], metaclass=ABCMeta):
    def __init__(self, field: Field[Entity_T, Value_T, Any]):
        LateSync.__init__(self)
        FieldEventListener.__init__(self, field)


class FieldIndexModel(FieldLateSync[Entity_T, Value_T], metaclass=ABCMeta):
    @classmethod
    def _init(cls):
        return {}
...
class FieldInvertedIndexModel(FieldLateSync[Entity_T, Value_T], metaclass=ABCMeta):
    @classmethod
    def _init(cls):
...
class FieldInvertedIndexUnique(Mapping[Value_T, Entity_T]):
    def __init__(self, _data_input: FieldInvertedIndexModel[Entity_T, Value_T],
    ...
    def __repr__(self) -> str:
        ...
        return repr_object(self, view_type=f'inverted_index_{self.position}', field_type=self.field_type, data=data)
