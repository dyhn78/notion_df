...
class Field(Generic[Entity_T, FieldValue_T, FieldValueInput_T]):
    ...
    @overload
    def __get__(self: Field_T & Field, instance: None, entity_type: Type[Entity_T]) -> Field_T:
        ...

    @overload
    def __get__(self: Field_T & Field, instance: Entity_T, entity_type: Type[Entity_T]) -> FieldValue_T:
        ...

    def __get__(self, instance, entity_type):
        if instance is None:
            return self
