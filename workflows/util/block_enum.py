...
class BlockEnum(Enum):
    ...
    grounds = ('바탕', 'fa7d93f6fbd341f089b185745c834811', EmojiCode.ORANGE_HEART)
    ...
    divisions = ('부문', '52d387ea0aaa470cb69332708c61b34d', EmojiCode.YELLOW_HEART)

    subjects = ('꼭지', '2c5411ba6a0f43a0a8aa06295751e37a', EmojiCode.PURPLE_CIRCLE)
    ...
    sections = ('마디', '9f21ad86079d4caaa7ed9461a7f37288', EmojiCode.RED_HEART)
