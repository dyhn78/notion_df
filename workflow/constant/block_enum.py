...
class DatabaseEnum(Enum):
    ...
    session_db = ('마디', '9f21ad86079d4caaa7ed9461a7f37288', EmojiCode.BLUE_HEART)

    reading_db = ('읽기', 'c326f77425a0446a8aa309478767c85b', EmojiCode.YELLOW_CIRCLE)
    agenda_db = ('담론', 'eca1ba6d4831459ca8becc283f1f8c4e', EmojiCode.YELLOW_HEART)

    stream_db = ('전개', 'eb2f09a1de41412e8b2357bc04f26e74', EmojiCode.RED_CIRCLE)
    issue_db = ('꼭지', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.RED_HEART)

    topic_db = ('주제', '2c5411ba6a0f43a0a8aa06295751e37a', EmojiCode.PURPLE_CIRCLE)
    division_db = ('분과', '52d387ea0aaa470cb69332708c61b34d', EmojiCode.PURPLE_HEART)
