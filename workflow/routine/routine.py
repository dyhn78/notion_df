...
class WorkflowAction(CompositeAction):
    def __init__(self):
...
if __name__ == '__main__':
    # WorkflowAction().run_by_last_edited_time(datetime(2024, 1, 7, 17, 0, 0, tzinfo=my_tz), None)
    # WorkflowAction().run_recent(interval=timedelta(hours=24))
