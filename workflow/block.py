...
class DatabaseEnum(Enum):
    event_db = ('일과', 'c8d46c01d6c941a9bf8df5d115a05f03', EmojiCode.GREEN_CIRCLE)
    journal_db = ('바탕', 'fa7d93f6fbd341f089b185745c834811', EmojiCode.GREEN_HEART)
    idea_db = ('꼭지', '52d387ea0aaa470cb69332708c61b34d', EmojiCode.BLUE_CIRCLE)
    stage_db = ('줄기', 'addc94642ee74825bd31109f4fd1c9ee', EmojiCode.BLUE_HEART)
