...
class DatabaseEnum(Enum):
    ...
    point_db = ('요점', '52d387ea0aaa470cb69332708c61b34d', EmojiCode.GREEN_HEART)
    ...
    summit_db = ('꼭지', 'eb2f09a1de41412e8b2357bc04f26e74', EmojiCode.RED_CIRCLE)
    topic_db = ('주제', '2c5411ba6a0f43a0a8aa06295751e37a', EmojiCode.RED_HEART)
