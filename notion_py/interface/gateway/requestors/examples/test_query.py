...
#
# from notion_py.gateway.gateway.query import Query
# from notion_py.gateway.utility import stopwatch
#
#
...
#
# name_frame = test_db_query_maker.filter_maker.text_of('이름')
