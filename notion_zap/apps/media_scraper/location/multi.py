...
from notion_zap.apps.media_scraper.location.gy import GoyangLibraryScrapBase
from notion_zap.apps.media_scraper.location.snu import SNULibraryScrapBase
from notion_zap.apps.media_scraper.location.struct import LibraryScrapBase
from notion_zap.cli.utility import stopwatch


class MultiLibraryScraper:
...
if __name__ == '__main__':
    stack = MultiLibraryScraper({'gy'}, create_window=True)
    stack('책 이름')
