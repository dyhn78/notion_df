...
class MyBlock(Enum):
    ...
    events = ('일과', 'c226cffe6cf84ab996bbc384bf26bf1d', EmojiCode.BROWN_HEART)
    journals = ('진행', 'c8d46c01d6c941a9bf8df5d115a05f03', EmojiCode.BROWN_CIRCLE)
    ...
    people = ('인물', '3c08cdba5a044e9c9b7e31ee8509f506', EmojiCode.BROWN_HEART)
    channels = ('채널', '2d3f4ea770854b8e9e30abecd4d31a86', EmojiCode.BROWN_HEART)
