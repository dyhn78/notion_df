...
class MyBlock(Enum):
    ...
    notes = ('전개', 'fa7d93f6fbd341f089b185745c834811', EmojiCode.WHITE_CIRCLE)
    ...
    issues = ('바탕', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.BLUE_CIRCLE)
    writings = ('표현', '069bbebd632f4a6ea3044575a064cf0f', EmojiCode.BLUE_HEART)
