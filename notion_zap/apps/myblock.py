...
class MyBlock(Enum):
    ...
    themes = ('주제', '5464267393e940a58e3f10db306bf3e4', EmojiCode.PURPLE_CIRCLE)
    topics = ('중심', 'eca1ba6d4831459ca8becc283f1f8c4e', EmojiCode.PURPLE_HEART)
    ...
    issues = ('정리', '9f21ad86079d4caaa7ed9461a7f37288', EmojiCode.BLUE_HEART)

    streams = ('줄기', 'eb2f09a1de41412e8b2357bc04f26e74', EmojiCode.RED_CIRCLE)
    tasks = ('꼭지', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.RED_HEART)
