...
class MyBlock(Enum):
    ...
    processes = ('진행', 'c8d46c01d6c941a9bf8df5d115a05f03', EmojiCode.ORANGE_HEART)
    ...
    tasks = ('과제', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.BLUE_HEART)
    ...
    issues = ('주관', '8baa30054f00483a8f0538fd3cd9543a', EmojiCode.WHITE_CIRCLE)
