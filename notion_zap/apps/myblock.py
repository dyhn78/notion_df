...
class MyBlock(Enum):
    ...
    journals = ('바탕', 'fa7d93f6fbd341f089b185745c834811', EmojiCode.BLUE_CIRCLE)
    issues = ('요점', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.BLUE_HEART)
    ...
    summaries = ('정리', 'eca1ba6d4831459ca8becc283f1f8c4e', EmojiCode.RED_HEART)

    readings = ('읽기', 'c326f77425a0446a8aa309478767c85b', EmojiCode.YELLOW_CIRCLE)
    grounds = ('마디', '2c5411ba6a0f43a0a8aa06295751e37a', EmojiCode.YELLOW_HEART)

    topics = ('꼭지', '5464267393e940a58e3f10db306bf3e4', EmojiCode.PURPLE_CIRCLE)
    groups = ('갈래', '679c2515870d46e3a107b42cd2a5ffc3', EmojiCode.PURPLE_HEART)
    ...
    notes = ('생활', '52df5fae504b4d35918b03bb82080500', EmojiCode.BLACK_HEART)
    tasks = ('과제', '8baa30054f00483a8f0538fd3cd9543a', EmojiCode.BLACK_HEART)
