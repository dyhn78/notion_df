class DatabaseInfo:
    ...
    MARKS = ('일지', 'c8d46c01d6c941a9bf8df5d115a05f03')
    JOURNALS = ('쓰기', '069bbebd632f4a6ea3044575a064cf0f')
    TASKS = ('메모', 'e8782fe4e1a34c9d846d57b01a370327')
    SCHEDULES = ('일정', 'c226cffe6cf84ab996bbc384bf26bf1d')
