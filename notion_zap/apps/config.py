...
class MyBlock(Enum):
    ...
    events = ('전개', 'c226cffe6cf84ab996bbc384bf26bf1d', EmojiCode.PURPLE_HEART)

    issues = ('주목', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.ORANGE_CIRCLE)
    targets = ('꼭지', 'fa7d93f6fbd341f089b185745c834811', EmojiCode.ORANGE_HEART)

    domains = ('주제', 'eca1ba6d4831459ca8becc283f1f8c4e', EmojiCode.BLUE_CIRCLE)
    projects = ('분야', '69b4e661c4ee43b6a5e40c8b28e6f9d1', EmojiCode.BLUE_HEART)    
