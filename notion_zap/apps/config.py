...
class MyBlock(Enum):
    ...
    points = ('요점', 'd85c92b28cbe47b7a4f044abc2efbd25', EmojiCode.YELLOW_STAR)
    writings = ('쓰기', '069bbebd632f4a6ea3044575a064cf0f', EmojiCode.YELLOW_HEART)

    processes = ('전개', 'eb2f09a1de41412e8b2357bc04f26e74', EmojiCode.RED_CIRCLE)
    channels = ('채널', '2d3f4ea770854b8e9e30abecd4d31a86', EmojiCode.RED_HEART)

    domains = ('꼭지', '2c5411ba6a0f43a0a8aa06295751e37a', EmojiCode.ORANGE_CIRCLE)
...
if __name__ == '__main__':
    ...
    print(id_to_url(MyBlock.journals.id_or_url))
