...
class MyBlock(Enum):
    ...
    events = ('진행', 'c226cffe6cf84ab996bbc384bf26bf1d', EmojiCode.PURPLE_HEART)

    issues = ('전개', 'e8782fe4e1a34c9d846d57b01a370327', EmojiCode.BLUE_CIRCLE)
    targets = ('요점', 'fa7d93f6fbd341f089b185745c834811', EmojiCode.BLUE_HEART)

    projects = ('분야', '69b4e661c4ee43b6a5e40c8b28e6f9d1', EmojiCode.GLOBE_ASIA)
