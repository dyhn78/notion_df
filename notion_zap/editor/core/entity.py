...
class Field(Generic[T_FieldValue, T_FieldValueInput, T_Entity]):
    ...
    def get_inverted_index_all(self) -> InvertedIndexAll[T_Entity, T_FieldValue]:
        return self._inverted_index_dict.get('all', InvertedIndexAll(self))

    def get_inverted_index_first(self) -> InvertedIndexFirst[T_Entity, T_FieldValue]:
        return self._inverted_index_dict.get('first', InvertedIndexFirst(self))

    def get_inverted_index_last(self) -> InvertedIndexLast[T_Entity, T_FieldValue]:
        return self._inverted_index_dict.get('last', InvertedIndexLast(self))

    @property
    def ii_all(self):
        """alias of get_inverted_index_all()"""
        return self.get_inverted_index_all()

    @property
    def ii_first(self):
        """alias of get_inverted_index_first()"""
        return self.get_inverted_index_first()

    @property
    def ii_last(self):
        """alias of get_inverted_index_last()"""
        return self.get_inverted_index_last()


class InvertedIndex(Generic[T_Entity, T_FieldValue]):
    def __init__(self, field: Field[T_Entity, T_FieldValue]):
        self.field = field
...
class InvertedIndexAll(InvertedIndex[T_Entity, T_FieldValue]):
    def __init__(self, field: Field[T_Entity, T_FieldValue]):
...
class InvertedIndexFirst(InvertedIndex[T_Entity, T_FieldValue]):
    def __init__(self, field: Field[T_Entity, T_FieldValue]):
        super().__init__(field)
...
class InvertedIndexLast(InvertedIndex[T_Entity, T_FieldValue]):
    def __init__(self, field: Field[T_Entity, T_FieldValue]):
        super().__init__(field)
        self._data: dict[T_FieldValue, T_Entity] = {}
